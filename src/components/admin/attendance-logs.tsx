      ...
      <AnimatePresence mode="wait">
        {!selectedStudent ? (
          ...
          >
            ...
            <div className="bg-card border border-border/40 rounded-3xl p-6 md:p-8 shadow-md flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex items-center gap-5">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground font-semibold uppercase tracking-wider">
